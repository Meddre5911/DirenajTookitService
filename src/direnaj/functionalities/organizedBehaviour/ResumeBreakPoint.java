...
public enum ResumeBreakPoint {
	...
	HOURLY_CALCULATION_DONE(8), //
	ALL_HOURLY_CALCULATION_DONE(9), //
	GENERAL_STATISCTIC_CALCULATION_DONE(10), //
	GENERAL_CAMPAIGN_CALCULATION_DONE(11), //
	STATISCTIC_CALCULATED(12), //
	FINISHED(13);
