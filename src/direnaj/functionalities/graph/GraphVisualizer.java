...
/**
 * Demonstrates several of the graph layout algorithms. Allows the user to interactively select one of several graphs,
 * and one of several layouts, and visualizes the combination.
 * 
...
public class GraphVisualizer extends JApplet {
    ...
    protected static String[] graph_names = { "GraphVisualizer" };
