...
public class DirenajDriverUtils {
	...
	/**
	 * @param tweetData
	 *            Tweet Data JSON object which is retrived from the Results JSON
	 *            Array
	...
	/**
	 * @param results
	 *            Result Json Array retrieved from Main JSON data that Direnaj
	 *            is sent
	 * @param index
	 *            index of Tweet data in the results array
	 *            <p>
	 *            <b>Note that : </b> Tweet data mentioned here does not only
	 *            compose of tweet text. It has all data relevant with tweet
	 *            such as user, tweet, entities, hashtags etc ...
	...
	public static User parseUser(JSONObject tweet) throws DirenajInvalidJSONException {
		try {
			...
			user.setCampaignTweetId(getTweetId(tweet));
			return user;
		} catch (Exception e) {
