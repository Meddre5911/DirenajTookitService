package tr.edu.boun.cmpe.direnaj.processor.nlp.algorithms.similarity;
 ...
 * matrix. Specifies a protected abstract computeSimilarity() method that must
 * be defined for concrete subclasses.
 * 
 * @author Sujit Pal
 * @version $Revision: 21 $
 */
public abstract class AbstractSimilarity implements
		Transformer<RealMatrix, RealMatrix> {
