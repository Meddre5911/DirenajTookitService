...
<body>
<div id = "first">
	<label>Before Sentiment Analysis <b>${searchedCommunityName}</b>  </label>
	...
	<script>
		...
		d3.json("http://localhost:8080/DirenajToolkitService/communitySentimentAnalysis?sentimentalCommunity=false", function(error, graph) {
