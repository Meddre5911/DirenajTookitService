...
<title>Campaign Hashtag Counts</title>
</head>
<body>
	...
	<table>
		<tr>
			...
			<%
				...
				// get map
				Map<String,Double> hashtagCounts = (Map<String, Double>) campaignStatistic.get(MongoCollectionFieldNames.MONGO_CAMPAIGN_HASHTAG_COUNTS);
// 				Map<String,Double> sortedWordFrequencyMap = CollectionUtil.sortByComparator(wordFrequencyMap);
				StringBuilder sBuilder = new StringBuilder();
				for (Entry<String, Double> hashtagCount : hashtagCounts.entrySet()) {
					sBuilder.append("<tr><td><a href=\"https://twitter.com/hashtag/"+hashtagCount.getKey()+"?src=hash\" target=\"_blank\">#"+hashtagCount.getKey()+"</a></td><td>"+hashtagCount.getValue()+"</td></tr>");
				}
